...
const TransactionView = () => {
  return (
    <div>
         <nav
            id="nav"
            className="d-block d-sm-block d-md-none d-lg-none fixed-bottom nav d-flex justify-content-center flex-row nav-tabs mt-0 bg-light">
            <div className="nav-item">
            <Link
                className="nav-link menu-list d-flex flex-column text-center"
                to=""
                ><div>
                <svg
                    width="19"
                    ...
                    fill="#c3c2c8">
                    <path
                    d="M17.9487 9.04847L9.77668 0.404627C9.71784 0.342222 9.64795 0.292712 9.57102 0.258932C9.49408 0.225151 9.4116 0.207764 9.32831 0.207764C9.24501 0.207764 9.16254 0.225151 9.0856 0.258932C9.00866 0.292712 8.93877 0.342222 8.87993 0.404627L0.707948 9.04847C0.469871 9.30047 0.334961 9.64278 0.334961 9.99979C0.334961 10.7411 0.904361 11.3438 1.6047 11.3438H2.46575V17.5117C2.46575 17.8834 2.74946 18.1837 3.10062 18.1837H8.05856V13.4796H10.2806V18.1837H15.556C15.9072 18.1837 16.1909 17.8834 16.1909 17.5117V11.3438H17.0519C17.3892 11.3438 17.7126 11.2031 17.9506 10.949C18.4447 10.424 18.4447 9.57348 17.9487 9.04847Z"
                    />
                </svg>
                </div>
                <small>Home</small>
            ...
            <div className="nav-item">
            <Link className="nav-link menu-list d-flex flex-column text-center" to=""
                ><div>
                <svg
                    width="19"
                    height="19"
            ...
            <Link
                className="nav-link d-flex flex-column align-item-center ml-auto position-absolute"
            ...
            <div className="create-bdgt d-flex align-item-center ">
                <Link to="">
                    <svg width="18" height="12" viewBox="0 0 18 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M18 5H3.83L7.41 1.41L6 0L0 6L6 12L7.41 10.59L3.83 7H18V5Z" fill="#ff5460"/>
                        </svg>
                </Link>
                <h2 className="fs-6 fw-bold ps-2 mb-0 align-self-end">Transaction</h2>
            </div>
        </header>
        <main className="text-center pt-1 pb-5  empty-budget-main   ">
            <section className="">
                <div className="text-start my-3 w-80 mx-auto">
                    <p className="budget-label opacity-40 mb-1">Payee</p>
                    <h4 className="fs-6 fw-bold">Motorbike engine oil</h4>
                </div>
                <div className="text-start d-flex justify-content-between align-items-center w-80 py-3 mx-auto">
                    ...
                    <div className="create-bdgt-name w-50  ps-5   date-border">
                        <p className="budget-label mb-1  opacity-40">Date</p>
                        <h4 className="fs-6 fw-bold">04-16-19</h4>
                    </div>
                </div>
                <div className="divider d-flex  align-items-center   w-90 me-auto py-4">
                    <div className="rounded-circle ms-2" style= {{backgroundColor: "#1d2025", width: "20px", height: "20px"}}></div>
                    <div className="border-dashed opacity-40 w-90 ms-2" ></div>
                </div>
                <div className="d-flex justify-content-between align-items-center w-80 mx-auto">
