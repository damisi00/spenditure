    ...
    <div>
        <nav className="container-fluid   py-2 " style={{color: "#1d2025"}}>
            <div className="create-bdgt d-flex align-item-center ">
                <Link to=""><img src={Arrow2} alt="back arrow icon" /></Link>
        ...
        <main className="text-start pt-1 pb-5  empty-budget-main w-90  mx-auto">
            ...
            <form id="create-budget">
                ...
                <div className=" create-bdgt-name pb-3">
                    <label for="account-name" className="form-label budget-label  ">Account name</label>
                    <input type="text" className="form-control py-1 px-0" placeholder="Account name here" id="account-name" required />
                </div>
                <div className=" create-bdgt-name pb-3">
                    <label for="starter-amount" className="form-label budget-label  ">Starter amount</label>
                    <input type="text" className="form-control py-1 px-0" placeholder="$0,0000.00" id="starter-amount" required />
                </div>
                <Link to="./Account-successful" className="text-decoration-none">
                    <button type="button" className="btn account-submit-btn mt-3 w-100">Submit</button>
                </Link>
            </form> 
        </main>
    </div>
